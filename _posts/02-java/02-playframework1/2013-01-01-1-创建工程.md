...
[![image](http://freewind.me/wp-content/uploads/2013/01/image8.png "image")](http://freewind.me/wp-content/uploads/2013/01/image8.png)
...
[![image](http://freewind.me/wp-content/uploads/2013/01/image9.png "image")](http://freewind.me/wp-content/uploads/2013/01/image9.png)
...
这个应用的主要入口在**conf/routes**文件中定义，包括了所有可以被访问的URLs.打开这个自动生成的routes文件，你可以看到第一个'route'：
    ...
    **#{extends 'main.html'/}** tag 告诉Play这个模板继承了一个叫**main.html**的模板.模板继承是一个很强大的感念，它允许你通过重用公用部分,创建一个相当复杂的网页。
    ...
    [![image](http://freewind.me/wp-content/uploads/2013/01/image10.png "image")](http://freewind.me/wp-content/uploads/2013/01/image10.png)
